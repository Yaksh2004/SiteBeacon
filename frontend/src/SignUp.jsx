export function SignUp() {
    return (
        <div className="m-5 p-10 flex flex-col justify-center w-fit shadow border border-gray-200 rounded-2xl">
            ...
            <div className="text-center mt-2">Already have an account? <span className="font-semibold text-blue-500 hover:text-blue-700 cursor-pointer">Login</span></div>
        </div>
    )
}